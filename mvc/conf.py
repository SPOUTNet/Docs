...
htmlhelp_basename = 'aspnetmvcdoc'
...
latex_documents = [
  (master_doc, 'ASPNETMVC.tex', 'ASP.NET MVC 6 Documentation',
   'Microsoft', 'manual'),
]
...
man_pages = [
    (master_doc, 'aspnetmvc', 'ASP.NET MVC 6 Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'ASPNETMVC', 'ASP.NET MVC 6 Documentation',
   author, 'ASPNETMVC', 'ASP.NET MVC 6 Documentation',
   '.NET Development'),
]
